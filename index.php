...
$routes = [
    ...
    '/movies/list' => 'crud/MovieList/admin_listMovie.php',
    '/movies/add' => 'crud/MovieList/admin_addMovie.php',
    '/movies/edit' => 'crud/MovieList/admin_editMovie.php',
    '/cars/list' => 'crud/CarList/admin_listCar.php',
    '/cars/add' => 'crud/CarList/admin_addCar.php',
