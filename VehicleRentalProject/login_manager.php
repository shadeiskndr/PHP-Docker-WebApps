    ...
    <div class="flex">
        ...
        <div class="flex-1 p-4">
            <header class="bg-blue-600 text-white p-4 rounded mb-4">
                <h1 class="text-4xl font-bold">Manager Log in</h1>
            </header>
            <main class="mt-8">
                <section class="my-8">
                    <h2 class="text-3xl font-semibold mb-4">Log in to your account</h2>
                    <form action="login_manager.php" method="post" class="space-y-4">
                        <div>
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errorMessage)) { // If everything's OK.
        ...
        /* Retrieve the managerID and name for 
        that email/password combination. */
        $query = "SELECT managerID, name FROM manager WHERE email='$email' AND password=SHA('$password')";        
        ...
        if ($row) { // A record was pulled from the database.
            ...
            // Redirect the user to the loggedin_manager.php page.
