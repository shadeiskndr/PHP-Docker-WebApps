...
$page_title = 'Vehicle Rental Request List';
...
<head>
    ...
    <title>Vehicle Rental Request List</title>
</head>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-4">
            <header class="bg-blue-600 text-white p-4 rounded mb-4">
                <h1 class="text-4xl font-bold">Vehicle Rental Request List</h1>
            </header>
            ...
            <main class="mt-8">
                <section class="my-8">
                    ...
                    <form action="mngr_listReq.php" method="post" class="space-y-4">
                        <div>
                            ...
                            <select id="status" name="status" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                ...
                                <?php
                                    $query = "SELECT DISTINCT status FROM rental";        
